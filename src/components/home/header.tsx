...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      {/* Geometric accents — forest green glow */}
      <div className="absolute right-[-10%] top-[15%] h-[500px] w-[500px] rounded-full bg-forest/[0.04] blur-3xl" />
      <div className="absolute left-[-5%] bottom-[10%] h-[300px] w-[300px] rounded-full bg-amber/[0.04] blur-3xl" />
      ...
      <div className="relative mx-auto flex min-h-[calc(100svh-4rem)] max-w-7xl flex-col justify-center px-5 py-20">
        <div className="max-w-4xl">
          ...
          <h1 className="reveal-item mt-8 translate-y-8 opacity-0 transition-all delay-100 duration-700">
            ...
            <span className="block font-heading text-[clamp(2.8rem,7vw,5.5rem)] font-extrabold leading-[0.92] tracking-tight text-amber-brand">
              tomorrow.
            </span>
          </h1>
          ...
          <div className="reveal-item mt-10 flex flex-col gap-4 opacity-0 translate-y-8 transition-all delay-300 duration-700 sm:flex-row">
            <Link href="/login">
              <Button size="lg" className="h-14 bg-amber hover:bg-amber-dark px-8 text-base font-semibold text-ink">
                Find a ride
            ...
            <Link href="/login">
              <Button
                size="lg"
                variant="outline"
                className="h-14 border-forest/30 px-8 text-base font-semibold hover:bg-forest/5 dark:border-forest-light/30"
              >
                Offer seats &amp; earn
              </Button>
            </Link>
